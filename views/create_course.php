...
<body class="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white min-h-screen">
    ...
    <main class="max-w-6xl mx-auto px-4 py-8">
        <div class="mb-6">
            ...
            <p class="text-gray-400">Fill in the details to create your course</p>
        </div>
        ...
        <form action="../processes/coursePros.php" method="POST" class="space-y-8">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" 
                                  ...
                                  class="w-full bg-purple-500/10 border border-purple-500/20 rounded-xl px-4 py-2.5
                                         focus:outline-none focus:border-purple-500/50 text-white placeholder-gray-400"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end gap-4">
                ...
                <button type="submit" name='addCourse'
