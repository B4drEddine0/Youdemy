...
if(isset($_GET['status'])){
  ...
  </div>';}elseif($_GET['status']==='suspended'){
    echo '<div class="fixed top-4 left-1/2 transform -translate-x-1/2 w-full max-w-md z-50">
    <div class="bg-gradient-to-r from-red-500/10 to-rose-500/10 backdrop-blur-md 
               border border-red-400/20 rounded-2xl p-6 shadow-2xl 
               animate-fade-in-down">
        <div class="flex items-center gap-4">
            <div class="flex-shrink-0">
            ...
            <div>
                <h3 class="text-xl font-semibold text-white mb-1">Compte suspendu</h3>
                <p class="text-gray-300">
  ...
  </div>';}elseif($_GET['status']==='deleted'){
    echo '<div class="fixed top-4 left-1/2 transform -translate-x-1/2 w-full max-w-md z-50">
    <div class="bg-gradient-to-r from-red-500/10 to-rose-500/10 backdrop-blur-md 
               border border-red-400/20 rounded-2xl p-6 shadow-2xl 
               animate-fade-in-down">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h3 class="text-xl font-semibold text-white mb-1">Compte supprimé</h3>
                <p class="text-gray-300">
                    Votre compte a été supprimé. Si vous pensez qu\'il s\'agit d\'une erreur, 
